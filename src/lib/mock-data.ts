...
// Visibility, listings, and prices are point-in-time snapshots seeded for a
// specific period. If the selected period has no data, fall back to the latest
// period that does — so pages always display something meaningful.
